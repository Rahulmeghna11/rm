...
bot = telebot.TeleBot('8112795608:AAGVJMRik8S9XU2C5Ho2SLzIwSwXeGWHphs')
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access!🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    "To gain access and unleash the power of attacks, you can:\n\n👉 Contact an Admin or the Owner:- @RAHUL_DDOS_B for approval.\n"
...
3. MAKE SURE YOU JOINED @RAHUL_DDOS_B OTHERWISE NOT WORK
...
def send_welcome(message):
   ...
   # btn3 = telebot.types.KeyboardButton('ℹ️ My Info')
    markup.add(btn1)
    bot.send_message(message.chat.id, "Welcome 😄\n Provide powerfull DDOS attack \n 27/7 available \n No cooldown \n Dm For Access :- @RAHUL_DDOS_B", reply_markup=markup)
